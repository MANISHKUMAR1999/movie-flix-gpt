...
<option value={lang.identifier}>{lang.name}</option>
        ...
        <button className='py-2 px-4 mx-2 my-2 bg-purple-700 text-white rounded-lg' onClick={handleGptSearchClick}>{showGptSearch ? 'Gpt Search' : 'Home'}</button>
